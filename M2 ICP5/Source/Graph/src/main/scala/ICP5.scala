...
object ICP5 {
  def main(args: Array[String]) {
    ...
    stationGraph.vertices.write.csv("C:\\Users\\praka\\OneDrive\\Desktop\\Rank\\Graphs1")

    stationGraph.edges.write.csv("C:\\Users\\praka\\OneDrive\\Desktop\\Rank\\Graphs1\\graph2")
